...
def test_parse_packet_returns_telemetry_data() -> None:
    ...
    assert result.normalized_suspension_travel_front_left == pytest.approx(
        expected_data.normalized_suspension_travel_front_left
    )
    assert result.normalized_suspension_travel_front_right == pytest.approx(
        expected_data.normalized_suspension_travel_front_right
    )
    assert result.normalized_suspension_travel_rear_left == pytest.approx(
        expected_data.normalized_suspension_travel_rear_left
    )
    assert result.normalized_suspension_travel_rear_right == pytest.approx(
        expected_data.normalized_suspension_travel_rear_right
    )
    assert result.tire_slip_ratio_front_left == pytest.approx(
        expected_data.tire_slip_ratio_front_left
    )
    assert result.tire_slip_ratio_front_right == pytest.approx(
        expected_data.tire_slip_ratio_front_right
    )
    assert result.tire_slip_ratio_rear_left == pytest.approx(
        expected_data.tire_slip_ratio_rear_left
    )
    assert result.tire_slip_ratio_rear_right == pytest.approx(
        expected_data.tire_slip_ratio_rear_right
    )
    assert result.wheel_rotation_speed_front_left == pytest.approx(
        expected_data.wheel_rotation_speed_front_left
    )
    assert result.wheel_rotation_speed_front_right == pytest.approx(
        expected_data.wheel_rotation_speed_front_right
    )
    assert result.wheel_rotation_speed_rear_left == pytest.approx(
        expected_data.wheel_rotation_speed_rear_left
    )
    assert result.wheel_rotation_speed_rear_right == pytest.approx(
        expected_data.wheel_rotation_speed_rear_right
    )
    assert (
        result.wheel_on_rumble_strip_front_left
        == expected_data.wheel_on_rumble_strip_front_left
    )
    assert (
        result.wheel_on_rumble_strip_front_right
        == expected_data.wheel_on_rumble_strip_front_right
    )
    assert (
        result.wheel_on_rumble_strip_rear_left
        == expected_data.wheel_on_rumble_strip_rear_left
    )
    assert (
        result.wheel_on_rumble_strip_rear_right
    ...
    assert (
        result.wheel_in_puddle_front_right == expected_data.wheel_in_puddle_front_right
    )
    ...
    assert result.surface_rumble_front_left == pytest.approx(
        expected_data.surface_rumble_front_left
    )
    assert result.surface_rumble_front_right == pytest.approx(
        expected_data.surface_rumble_front_right
    )
    assert result.surface_rumble_rear_left == pytest.approx(
        expected_data.surface_rumble_rear_left
    )
    assert result.surface_rumble_rear_right == pytest.approx(
        expected_data.surface_rumble_rear_right
    )
    assert result.tire_slip_angle_front_left == pytest.approx(
        expected_data.tire_slip_angle_front_left
    )
    assert result.tire_slip_angle_front_right == pytest.approx(
        expected_data.tire_slip_angle_front_right
    )
    assert result.tire_slip_angle_rear_left == pytest.approx(
        expected_data.tire_slip_angle_rear_left
    )
    assert result.tire_slip_angle_rear_right == pytest.approx(
        expected_data.tire_slip_angle_rear_right
    )
    assert result.tire_combined_slip_front_left == pytest.approx(
        expected_data.tire_combined_slip_front_left
    )
    assert result.tire_combined_slip_front_right == pytest.approx(
        expected_data.tire_combined_slip_front_right
    )
    assert result.tire_combined_slip_rear_left == pytest.approx(
        expected_data.tire_combined_slip_rear_left
    )
    assert result.tire_combined_slip_rear_right == pytest.approx(
        expected_data.tire_combined_slip_rear_right
    )
    assert result.suspension_travel_meters_front_left == pytest.approx(
        expected_data.suspension_travel_meters_front_left
    )
    assert result.suspension_travel_meters_front_right == pytest.approx(
        expected_data.suspension_travel_meters_front_right
    )
    assert result.suspension_travel_meters_rear_left == pytest.approx(
        expected_data.suspension_travel_meters_rear_left
    )
    assert result.suspension_travel_meters_rear_right == pytest.approx(
        expected_data.suspension_travel_meters_rear_right
    )
    ...
    assert result.tire_temp_front_left == pytest.approx(
        expected_data.tire_temp_front_left
    )
    assert result.tire_temp_front_right == pytest.approx(
        expected_data.tire_temp_front_right
    )
    assert result.tire_temp_rear_left == pytest.approx(
        expected_data.tire_temp_rear_left
    )
    assert result.tire_temp_rear_right == pytest.approx(
        expected_data.tire_temp_rear_right
    )
    ...
    assert (
        result.normalized_ai_brake_difference
