...
_PACKET_FORMAT = "<iIfffffffffffffffffffffffffffiiiiiiiiffffffffffffffffIIIIIIfffffffffffffffffffHBBBBBBbbbx"
...
def parse_packet(data: bytes) -> TelemetryData:
    ...
    if len(data) != _PACKET_SIZE:
        raise PacketParseError(
            f"Invalid packet size: expected {_PACKET_SIZE} bytes, got {len(data)}"
        )
    (
        is_race_on,
        timestamp_ms,
